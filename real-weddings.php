...
<head>
    ...
    <title>Inspirasi Pernikahan</title>
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="h2 text-center mb-0">INSPIRASI TERAKHIR!</h4>
            <p class="text-muted text-center">Artikel dan ide-ide terbaik untuk menginspirasi pernikahanmu.</p>
        </div>
