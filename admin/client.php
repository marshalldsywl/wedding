    ...
    <?php foreach ($booking as $bookWedding) : ?>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="client_edit.php?booking=<?= $bookWedding->booking_id; ?>&user_id=<?= $bookWedding->user_id; ?>" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit Informasi Klien"><i class="mdi mdi-account-edit"></i></a>
