...
<head>
    ...
    <title>Rencana Pernikahan</title>
...
<div class="container" style="width: 70%;">
    ...
    <div class="row mb-3">
        <div class="col-lg-12">
            <h3 class="h5 text-uppercase text-center text-muted">Pernikahan</h3>
     ...
     <div class="row">
        <div class="col-md-12 p-0" style="margin-bottom: 20px;"> 
            ...
            <div class="float-left" style="width: 47%;"> 
                <ul class="list-group">
                    <li class="list-group-item bg-danger active" style="padding-top: 12px;"><h6 class="h6 text-center"><?= $category_row->wedding_type; ?> | Paket Pernikahan - Harga: Rp <?= number_format($category_row->price,2); ?></h6></li>
